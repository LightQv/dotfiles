...
- `opencode.json`
- `~/.config/opencode/agent/` or `~/.config/opencode/agents/`
...
Use the installed CLI help and <https://opencode.ai/docs/> as current sources. Validate configuration fields against <https://opencode.ai/config.json> before editing.
